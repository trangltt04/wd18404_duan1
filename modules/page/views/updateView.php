                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_title" id="page_title" value="<?php echo $page['page_title']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="page_content" class="form-control ckeditor" id="page_content" cols="30" rows="5"><?php echo $page['content']; ?></textarea>
